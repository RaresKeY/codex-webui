...
- `frontend/src/api.test.ts` and `frontend/src/turn-lifecycle.test.ts` cover 0.147 item/delta/turn normalization, history hydration, optimistic reconciliation, terminal cleanup, and lifecycle races.
