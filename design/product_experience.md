...
- Decide voice selection/transcript grouping, expanded search privacy, bulk organization, project nesting, Markdown/diff rendering, notifications, themes, and command palette.
